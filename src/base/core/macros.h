...
// the core::LINKER_INITIALIZED argument.  Normally, it is unsafe to declare a
...
//       explicit MyClass(core::LinkerInitialized x) {}
// and invoked as
//       static MyClass my_variable_name(core::LINKER_INITIALIZED);
namespace core {

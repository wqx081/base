...
class StringPiece {
 ...
 public:
  ...
  size_t find_first_of(char c, size_type pos = 0) const { return find(c, pos); }
  ...
  size_t find_last_of(char c, size_type pos = npos) const { return rfind(c, pos); }

...
#include "base/core/template_util.h"
#include "base/core/type_traits.h"
#include "base/core/move.h"
...
struct DefaultDeleter {
  ...
  template <typename U> DefaultDeleter(const DefaultDeleter<U>& other) {
    ...
    COMPILE_ASSERT((core::is_convertible<U*, T*>::value),
...
//
// gscoped_ptr<int, core::FreeDeleter> foo_ptr(
...
template <typename T> struct IsNotRefCounted {
  enum {
    value = !core::is_convertible<T*, core::subtle::RefCountedBase*>::value &&
        !core::is_convertible<T*, core::subtle::RefCountedThreadSafeBase*>::
            value
  };
};
...
class gscoped_ptr_impl {
 public:
  ...
  gscoped_ptr_impl(gscoped_ptr_impl<U, V>* other)
    ...
    // emulation to have core::subtle::move() and core::subtle::forward()
...
// types.
template <class T, class D = core::DefaultDeleter<T> >
class gscoped_ptr {
  MOVE_ONLY_TYPE_FOR_CPP_03(gscoped_ptr, RValue)

  COMPILE_ASSERT(core::internal::IsNotRefCounted<T>::value,
 ...
 public:
  ...
  gscoped_ptr(gscoped_ptr<U, V> other) : impl_(&other.impl_) {
    COMPILE_ASSERT(!core::is_array<U>::value, U_cannot_be_an_array);
  }
 ...
 private:
  typedef core::internal::gscoped_ptr_impl<element_type, deleter_type>
 ...
 private:
  ...
  core::internal::gscoped_ptr_impl<element_type, deleter_type> impl_;
...
// DEPRECATED: Use gscoped_ptr<C, core::FreeDeleter> instead.
//
// gscoped_ptr_malloc<> is similar to gscoped_ptr<>, but it accepts a
// second template argument, the functor used to free the object.

template<class C, class FreeProc = core::FreeDeleter>

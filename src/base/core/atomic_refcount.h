...
//    ...
//    void Ref() {
//      core::RefCountInc(&this->ref_count_);
//    }
//    void Unref() {
//      if (!core::RefCountDec(&this->ref_count_)) {
//        delete this;
//      }
//    }
...
// and also for core::subtle::Atomic64 if available on the platform.
...
inline void RefCountIncN(volatile Atomic32 *ptr, Atomic32 increment) {
  ...
  core::subtle::NoBarrier_AtomicIncrement(ptr, increment);
}
...
inline bool RefCountDecN(volatile Atomic32 *ptr, Atomic32 decrement) {
  ...
  bool res = core::subtle::Barrier_AtomicIncrement(ptr, -decrement) != 0;
  if (!res) {
...
inline bool RefCountDec(volatile Atomic32 *ptr) {
  return core::RefCountDecN(ptr, 1);
}
...
inline bool RefCountIsOne(const volatile Atomic32 *ptr) {
  bool res = core::subtle::Acquire_Load(ptr) == 1;
  if (res) {
    ANNOTATE_HAPPENS_AFTER(ptr);
  }
  return res;
...
inline void RefCountIncN(volatile core::subtle::Atomic64 *ptr,
                         core::subtle::Atomic64 increment) {
  DCHECK_GT(increment, 0);
  core::subtle::NoBarrier_AtomicIncrement(ptr, increment);
}
inline bool RefCountDecN(volatile core::subtle::Atomic64 *ptr,
                         core::subtle::Atomic64 decrement) {
  DCHECK_GT(decrement, 0);
  ANNOTATE_HAPPENS_BEFORE(ptr);
  bool res = core::subtle::Barrier_AtomicIncrement(ptr, -decrement) != 0;
  if (!res) {
...
inline void RefCountInc(volatile core::subtle::Atomic64 *ptr) {
  core::RefCountIncN(ptr, 1);
}
inline bool RefCountDec(volatile core::subtle::Atomic64 *ptr) {
  return core::RefCountDecN(ptr, 1);
}
inline bool RefCountIsOne(const volatile core::subtle::Atomic64 *ptr) {
  bool res = core::subtle::Acquire_Load(ptr) == 1;
  if (res) {
    ANNOTATE_HAPPENS_AFTER(ptr);
  }
...
inline bool RefCountIsZero(const volatile core::subtle::Atomic64 *ptr) {
  bool res = (core::subtle::Acquire_Load(ptr) == 0);
  if (res) {
    ANNOTATE_HAPPENS_AFTER(ptr);
  }
  return res;
...
inline bool RefCountIsOne(const volatile AtomicWord *ptr) {
  bool res = core::subtle::Acquire_Load(

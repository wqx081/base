...
template <typename T> struct IsMoveOnlyType {
  template <typename U>
  static core::YesType Test(const typename U::MoveOnlyTypeForCPP03*);

  template <typename U>
  static core::NoType Test(...);

  static const bool value = sizeof(Test<T>(0)) == sizeof(core::YesType) &&
...
template <typename T>
typename core::enable_if<!IsMoveOnlyType<T>::value, T>::type& CallbackForward(T& t) {
  return t;
}

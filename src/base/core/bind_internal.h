...
#include "base/core/bind_helpers.h"
#include "base/core/callback_internal.h"
#include "base/core/raw_scoped_refptr_mismatch_checker.h"
#include "base/core/template_util.h"

#if defined(OS_WIN)
#include "base/core/bind_internal_win.h"
#endif
...
// See base/core/callback.h for user documentation.
//
//
// CONCEPTS:
...
class RunnableAdapter<R(T::*)()> {
 public:
  typedef R (RunType)(T*);
  typedef core::true_type IsMethod;
...
struct BindState<Runnable, RunType, void()> : public BindStateBase {
  ...
  typedef core::false_type IsWeakCall;

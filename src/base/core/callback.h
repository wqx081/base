...
// Closure should #include "base/core/callback_forward.h" instead of this file.
...
//
// A callback with no unbound input parameters (core::Callback<void(void)>)
// is called a core::Closure. Note that this is NOT the same as what other
...
//   core::Callback<int(void)> func_cb = core::Bind(&Return5);
...
//
//   class Ref : public core::RefCountedThreadSafe<Ref> {
//    public:
//     int Foo() { return 3; }
//     void PrintBye() { LOG(INFO) << "bye."; }
//   };
//   scoped_refptr<Ref> ref = new Ref();
//   core::Callback<void(void)> ref_cb = core::Bind(&Ref::Foo, ref);
...
//
//   void DoSomething(const core::Callback<void(int, std::string)>& callback) {
//     callback.Run(5, "hello");
//   }
//
//   Callbacks can be run more than once (they don't get deleted or marked when
//   run). However, this precludes using core::Passed (see below).
//
//   void DoSomething(const core::Callback<double(double)>& callback) {
...
//   core::Callback<void(int, const std::string&)> cb = core::Bind(&MyFunc);
...
//
//   void MyFunc(int i, const std::string& str) {}
//   core::Callback<void(void)> cb = core::Bind(&MyFunc, 23, "hello world");
//   cb.Run();
//
//   A callback with no unbound input parameters (core::Callback<void(void)>)
//   is called a core::Closure. So we could have also written:
//
//   core::Closure cb = core::Bind(&MyFunc, 23, "hello world");
//
//   When calling member functions, bound parameters just go after the object
//   pointer.
//
//   core::Closure cb = core::Bind(&MyClass::MyFunc, this, 23, "hello world");
//
...
//
//   void MyFunc(int i, const std::string& str) {}
//   core::Callback<void(const std::string&)> cb = core::Bind(&MyFunc, 23);
//   cb.Run("hello world");
//
...
//
//   core::Bind(&MyClass::Foo, GetWeakPtr());
//
...
//
//   core::Bind(&MyClass::Foo, core::Unretained(this));
//
...
//   core::Bind(&MyClass::Foo, core::Owned(myclass));
//
...
//   core::Callback<void<int>) cb =
//       core::Bind(core::IgnoreResult(&DoSomething));
//
//
// -----------------------------------------------------------------------------
...
// Closure (core::Callback<void(void)> and core::Closure are the same thing).
//
// PASSING PARAMETERS OWNED BY THE CALLBACK
//
//   void Foo(int* arg) { cout << *arg << endl; }
//   int* pn = new int(1);
//   core::Closure foo_callback = core::Bind(&foo, core::Owned(pn));
//
...
//   core::Closure cb = core::Bind(&TakesOwnership, core::Passed(&f));
//
...
//   core::Closure cb = core::Bind(&TakesOneRef, f);
//
...
//   void foo(int arg) { cout << arg << endl }
//   int n = 1;
//   core::Closure has_ref = core::Bind(&foo, core::ConstRef(n));
//   n = 2;
...
// file-level comment in base/core/bind_helpers.h for more info.
//

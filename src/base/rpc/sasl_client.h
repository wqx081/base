#ifndef BASE_RPC_SASL_CLIENT_H
#define BASE_RPC_SASL_CLIENT_H
...
#include "base/rpc/sasl_helper.h"
...
class SaslClient {
 ...
 private:
  ...
  string plain_pass_;
  gscoped_ptr<sasl_secret_t, core::FreeDeleter> psecret_;

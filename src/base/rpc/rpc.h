#ifndef BASE_RPC_RPC_H
#define BASE_RPC_RPC_H
...
class ServerPicker : public core::RefCountedThreadSafe<ServerPicker<Server>> {
 public:
  virtual ~ServerPicker() {}

  typedef core::Callback<void(const Status& status, Server* server)> ServerPickedCallback;

#ifndef BASE_UTIL_THREAD_POOL_H
#define BASE_UTIL_THREAD_POOL_H
...
// std::function, which can be obtained via boost::bind().
//
// Usage Example:
...
class ThreadPool {
 public:
  ...
  Status SubmitClosure(const core::Closure& task) WARN_UNUSED_RESULT;

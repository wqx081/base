#ifndef BASE_UTIL_THREADLOCAL_H_
#define BASE_UTIL_THREADLOCAL_H_
...
do {                                                                            \
  if (PREDICT_FALSE(t == NULL)) {                                               \
    t = new T(__VA_ARGS__);                                                     \
    base::threadlocal::internal::PerThreadDestructorList* dtor_list =                 \
        new base::threadlocal::internal::PerThreadDestructorList();                   \
    dtor_list->destructor = base::threadlocal::internal::Destroy<T>;                  \
    dtor_list->arg = t;                                                         \
    base::threadlocal::internal::AddDestructor(dtor_list);                            \
  }                                                                             \
} while (false)
...
#endif // BASE_UTIL_THREADLOCAL_H_

#ifndef BASE_UTIL_STOPWATCH_H
#define BASE_UTIL_STOPWATCH_H
...
#define LOG_TIMING_PREFIX_IF(severity, condition, prefix, description) \
  for (base::sw_internal::LogTiming _l(__FILE__, __LINE__, google::severity, prefix, description, \
...
#define SCOPED_LOG_TIMING(severity, description) \
  base::sw_internal::LogTiming VARNAME_LINENUM(_log_timing)(__FILE__, __LINE__, \
...
#define LOG_SLOW_EXECUTION(severity, max_expected_millis, description) \
  for (base::sw_internal::LogTiming _l(__FILE__, __LINE__, google::severity, "", description, \
...
#define VLOG_TIMING(vlog_level, description) \
  for (base::sw_internal::LogTiming _l(__FILE__, __LINE__, google::INFO, "", description, \

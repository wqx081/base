#include "base/util/hdr_histogram.h"
...
using core::subtle::NoBarrier_AtomicIncrement;
using core::subtle::NoBarrier_Store;
using core::subtle::NoBarrier_Load;
using core::subtle::NoBarrier_CompareAndSwap;

#ifndef BASE_UTIL_THREAD_H
#define BASE_UTIL_THREAD_H
...
class Thread : public core::RefCountedThreadSafe<Thread> {
 public:
  ...
  // The current thread of execution, or NULL if the current thread isn't a base::Thread.
...
#error Unsupported platform
  ...
  // Thread::tid(), which only works on base::Threads.
  //

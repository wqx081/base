#ifndef BASE_UTIL_HDRHISTOGRAM_H_
#define BASE_UTIL_HDRHISTOGRAM_H_
...
class HdrHistogram {
 public:
  ...
  uint64_t TotalCount() const { return core::subtle::NoBarrier_Load(&total_count_); }

  // Sum of all events recorded.
  uint64_t TotalSum() const { return core::subtle::NoBarrier_Load(&total_sum_); }
 ...
 private:
  ...
  // Also hot.
  core::subtle::Atomic64 total_count_;
  core::subtle::Atomic64 total_sum_;
  core::subtle::Atomic64 min_value_;
  core::subtle::Atomic64 max_value_;
  gscoped_array<core::subtle::Atomic64> counts_;
...
#endif // BASE_UTIL_HDRHISTOGRAM_H_
